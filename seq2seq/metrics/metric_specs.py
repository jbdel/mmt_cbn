...
from seq2seq.metrics import meteor
...
class MeteorMetricSpec(TextMetricSpec):

  def __init__(self, params):
    super(MeteorMetricSpec, self).__init__(params, "meteor")

  def metric_fn(self, hypotheses, references):
    return meteor.compute(hypotheses, references)
