...
class AttentionSeq2Seq(BasicSeq2Seq):
  ...
  def _create_decoder(self, encoder_output, features, _labels):
    ...
    attention_layer_txt = attention_class(
        params=self.params["attention.params"], mode=self.mode, name="attention_txt")
    ...
    return self.decoder_class(
        ...
        attention_fn_txt=attention_layer_txt,
        image_features=encoder_output.image_features,
