...
class LayerNormGRUCell(rnn_cell_impl.RNNCell):
  ...
  def __init__(self,
    ...
    self._w_initializer = kernel_initializer
    self._u_initializer = kernel_initializer
  ...
  def __call__(self, inputs, state, scope=None):
    ...
    with tf.variable_scope(scope or "gru_cell") as scope:
      scope.set_initializer(self._w_initializer)
